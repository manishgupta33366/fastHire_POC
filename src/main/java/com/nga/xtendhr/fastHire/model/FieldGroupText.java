...
@Entity
@Table(name = "\"com.nga.poc.fasthire.db::Table.FHD_FIELD_GROUP_TEXT\"", schema = "POC_FAST_HIRE")
@NamedQueries({ @NamedQuery(name = "FieldGroupText.findAll", query = "SELECT f FROM FieldGroupText f"),
