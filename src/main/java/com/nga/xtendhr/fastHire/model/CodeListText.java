...
@Entity
@Table(name = "\"com.nga.poc.fasthire.db::Table.FHD_CODELIST_TEXT\"", schema = "POC_FAST_HIRE")
@NamedQueries({ @NamedQuery(name = "CodeListText.findAll", query = "SELECT f FROM CodeListText f"),
